        ...
        <div class="block-content">
            <form action="{{ route('lpm.roles.update', $role->id) }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="example-nf-email" name="title" value="{{ $role->title }}" placeholder="Enter Title..">
                </div>
                <div class="form-group">
                    <label for="example-nf-password">Name</label>
                    <input type="text" class="form-control" id="example-nf-password" name="name" value="{{ $role->name }}" placeholder="Enter Name..">
                </div>
                <div class="form-group">
