                ...
                <div class="block block-themed block-transparent mb-0">
                    <div class="block-header bg-primary-dark">
                        <h3 class="block-title">
                            {{ currentUser.id }} | {{ currentUser.name }} | Permissions
                        </h3>
                    ...
                    <div class="block-content">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="col-md-11">
                                    <v-select :options="roles" v-model="currentUser.roles" label="title" @input="changeRole" multiple></v-select>
                                </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            changeRole(roles) {
                let vm = this;
                UserRepository.assignRole(this.currentUser.id, roles);
                roles.forEach(function(role){
                    vm.attachAbility(role.abilities);
                });
            },
